	  ...
	  <?php settings_fields('optionsframework'); ?>
        ...
        <div id="header">
          ...
          <div class="site5author">
            <h2><a href="http://t.qq.com/rufeng1199/"><?php esc_attr_e( '作者','250100785' ); ?> <strong><?php esc_attr_e( '250100785','site5framework' ); ?></strong></a></h2>
          </div>
        ...
        <div class="of_admin_bar">
			<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( '保存','site5framework' ); ?>" />
            <input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认','site5framework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!','site5framework' ) ); ?>' );" />
		</div>
<div class="clear"></div>
	</form>
</div> <!-- / #container -->
